...
wl_registry.Listener wl_registry_listener = {
    &global_cb,
    &global_remove_cb,
};
...
main () {
    ...
    writeln (1);
    ctx.registry.add_listener (&wl_registry_listener,ctx);  // wl_proxy.add_listener
    writeln (2);
    ctx.display.roundtrip ();
    writeln (3);
    (cast (wl_proxy*) ctx.registry).wl_proxy_destroy ();
